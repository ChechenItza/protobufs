...
const (
	...
	BookingService_GetBookingsByResource_FullMethodName = "/booking.v1.BookingService/GetBookingsByResource"
)
...
func (c *bookingServiceClient) GetBookingsByResource(ctx context.Context, in *GetBookingsByResourceRequest, opts ...grpc.CallOption) (*GetBookingsByResourceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBookingsByResourceResponse)
	err := c.cc.Invoke(ctx, BookingService_GetBookingsByResource_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBookingServiceServer) GetBookingsByResource(context.Context, *GetBookingsByResourceRequest) (*GetBookingsByResourceResponse, error) {
...
func _BookingService_GetBookingsByResource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBookingsByResourceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookingServiceServer).GetBookingsByResource(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookingService_GetBookingsByResource_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).GetBookingsByResource(ctx, req.(*GetBookingsByResourceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BookingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BookingService_GetBookingsByResource_Handler,
		},
	},
